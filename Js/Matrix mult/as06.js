...
function ad(){
    ...
    ds1.innerHTML= (a1*b1)+(a2*b4)+(a3*b7);
    ds2.innerHTML= (a1*b2)+(a2*b5)+(a3*b8);
    ds3.innerHTML= (a1*b3)+(a2*b6)+(a3*b9);
    ds4.innerHTML= (a4*b1)+(a5*b4)+(a6*b7);
    ds5.innerHTML= (a4*b2)+(a5*b5)+(a6*b8);
    ds6.innerHTML= (a4*b3)+(a5*b6)+(a6*b9);
    ds7.innerHTML= (a7*b1)+(a8*b4)+(a9*b7);
    ds8.innerHTML= (a7*b2)+(a8*b5)+(a9*b8);
    ds9.innerHTML= (a7*b3)+(a8*b6)+(a9*b9);
